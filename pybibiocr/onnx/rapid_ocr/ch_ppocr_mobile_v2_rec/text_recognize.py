...
class TextRecognizer(object):
    def __init__(self, rec_model_path=None, keys_path=None):
        ...
        if rec_model_path is not None:
            ...
            self.rec_model_path = str(
                root_path.parent.joinpath('models').joinpath('ch_ppocr_mobile_v2.0_rec_infer.onnx'))
        print('TextRecognizer::rec_model_path =', self.rec_model_path)
        ...
        self.session = onnxruntime.InferenceSession(self.rec_model_path, sess_opt)
